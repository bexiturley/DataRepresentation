...
#Below error handling handy for production when put it out to real users but hides a lot of errors for ourselves so comment these out when debugging the code.
